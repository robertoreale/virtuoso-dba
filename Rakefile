...
namespace :book do
  ...
  desc "Generate the book and serve locally"
  task :serve do
    puts "not implemented"
  end

  desc "Generate the book, serve locally and watch for changes"
  task :watch do
    puts "not implemented"
  end

  desc "Generate the book and push changes to remote origin"
  task :deploy do
    puts "not implemented"
  end
end
